...
> Auto-generated by `elyos/task-decomposition` — 2026-06-29. All files are schema-valid per the
> Elyos taskSchema (draft-07). Seed task `arch-001` pre-existed; 26 new files generated. Fan-out
> dimensions: none (no explicitly enumerated fan-out dimensions in this backlog).

| File | ID | Milestone | Type | Priority | riskTier | Deliverable |
| --- | --- | --- | --- | --- | --- | --- |
| tasks/repair-cafe-kits-arch-001.json | repair-cafe-kits-arch-001 | M0 | design-spec | high | low | document |
| tasks/repair-cafe-kits-data-002.json | repair-cafe-kits-data-002 | M0 | data | high | medium | dataset |
| tasks/repair-cafe-kits-site-003.json | repair-cafe-kits-site-003 | M0 | code | high | low | pr |
| tasks/repair-cafe-kits-ci-004.json | repair-cafe-kits-ci-004 | M0 | code | high | low | pr |
| tasks/repair-cafe-kits-content-005.json | repair-cafe-kits-content-005 | M0 | writing | high | low | document |
| tasks/repair-cafe-kits-content-006.json | repair-cafe-kits-content-006 | M1 | writing | high | medium | document |
| tasks/repair-cafe-kits-content-007.json | repair-cafe-kits-content-007 | M1 | writing | high | medium | document |
| tasks/repair-cafe-kits-content-008.json | repair-cafe-kits-content-008 | M1 | writing | medium | medium | document |
| tasks/repair-cafe-kits-feat-009.json | repair-cafe-kits-feat-009 | M1 | code | high | low | pr |
| tasks/repair-cafe-kits-a11y-010.json | repair-cafe-kits-a11y-010 | M1 | code | high | low | pr |
| tasks/repair-cafe-kits-research-011.json | repair-cafe-kits-research-011 | M2 | research | high | medium | document |
| tasks/repair-cafe-kits-content-012.json | repair-cafe-kits-content-012 | M2 | writing | high | high | document |
| tasks/repair-cafe-kits-ci-013.json | repair-cafe-kits-ci-013 | M2 | code | high | medium | pr |
| tasks/repair-cafe-kits-i18n-014.json | repair-cafe-kits-i18n-014 | M3 | code | medium | low | pr |
| tasks/repair-cafe-kits-l10n-015.json | repair-cafe-kits-l10n-015 | M3 | writing | medium | medium | translation |
| tasks/repair-cafe-kits-content-016.json | repair-cafe-kits-content-016 | M3 | writing | medium | medium | document |
| tasks/repair-cafe-kits-research-017.json | repair-cafe-kits-research-017 | M3 | research | high | medium | document |
| tasks/repair-cafe-kits-deploy-018.json | repair-cafe-kits-deploy-018 | M3 | code | high | low | pr |
| tasks/repair-cafe-kits-ops-019.json | repair-cafe-kits-ops-019 | M3 | maintenance | medium | low | document |
| tasks/repair-cafe-kits-content-020.json | repair-cafe-kits-content-020 | Backlog | writing | low | medium | document |
| tasks/repair-cafe-kits-content-021.json | repair-cafe-kits-content-021 | Backlog | design-spec | low | low | document |
| tasks/repair-cafe-kits-content-022.json | repair-cafe-kits-content-022 | Backlog | writing | low | medium | document |
| tasks/repair-cafe-kits-data-023.json | repair-cafe-kits-data-023 | Backlog | data | low | medium | dataset |
| tasks/repair-cafe-kits-feat-024.json | repair-cafe-kits-feat-024 | Backlog | code | low | low | pr |
| tasks/repair-cafe-kits-ops-025.json | repair-cafe-kits-ops-025 | Backlog | maintenance | low | medium | document |
| tasks/repair-cafe-kits-sec-026.json | repair-cafe-kits-sec-026 | Backlog | maintenance | low | low | pr |
| tasks/repair-cafe-kits-content-027.json | repair-cafe-kits-content-027 | Backlog | writing | low | medium | document |

**Notes:**
- All tasks: `lane: "donated"`, `status: "open"`, `urgent: false`, `verifiedNeed: false`, `requestor: "TBD"` (no partner secured yet).
- `content-012` is the only `riskTier: "high"` task; it requires credentialed electrical SME sign-off (research-011 must complete first).
- `l10n-015` is a translation task (`type: "writing"`, `deliverable: "translation"`).
- `outputLicense`: `"MIT"` for code/data tasks; `"CC-BY-4.0"` for content/translation tasks.
